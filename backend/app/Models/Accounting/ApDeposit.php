...
class ApDeposit extends Model
{
    protected $fillable = [
        ...
        'supplier_name','account_id','bank_account_id','amount','paid_amount',
    ...
    public function lines(): HasMany          { return $this->hasMany(ApDepositLine::class)->orderBy('sort_order'); }
    public function payments(): HasMany       { return $this->hasMany(ApDepositPayment::class)->orderBy('payment_date'); }
}
