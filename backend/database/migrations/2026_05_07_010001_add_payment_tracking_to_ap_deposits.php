...
return new class extends Migration {
    ...
    {
        Schema::table('ap_deposits', function (Blueprint $table) {
            ...
            // Allow account_id like PV/OR for the offsetting account
            $table->foreignId('account_id')->nullable()->after('supplier_name')->constrained('accounts');
        });

        Schema::create('ap_deposit_lines', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamps();
            $table->index(['ap_deposit_id', 'sort_order']);
        });

        Schema::create('ap_deposit_payments', function (Blueprint $table) {
            $table->id();
            $table->foreignId('ap_deposit_id')->constrained('ap_deposits')->cascadeOnDelete();
            ...
            $table->timestamps();
            $table->index(['ap_deposit_id', 'payment_date']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('ap_deposit_payments');
        Schema::dropIfExists('ap_deposit_lines');
        Schema::table('ap_deposits', function (Blueprint $table) {
